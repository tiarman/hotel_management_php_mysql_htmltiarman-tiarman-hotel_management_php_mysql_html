     ...
     <div class="row">
        <div class="col-md-2">
            ...
            <div class="col-md-9">
                ...
                <h1 class="alignTitle">All Bookings Details</h1>
                <?php 
$username = "hotel"; 
$password = "1234"; 
...
echo '<table class="tableAlign" border="0" cellspacing="5" cellpadding="5"> 
      <tr> 
          ...
          <td> <font face="Arial">Booking email</font> </td> 
          <td> <font face="Arial">Phone</font> </td> 
          <td> <font face="Arial">Check In</font> </td> 
      </tr>';

if ($result = $mysqli->query($query)) {
    while ($row = $result->fetch_assoc()) {
        $signup_user = $row["signup_user"];
        $signup_name = $row["book_name"];
        $signup_gender = $row["visitor_name"];
        $signup_mobile = $row["visitor_email"];
        $signup_email = $row["visitor_phone"];
        $signup_email = $row["checkin"];
